  ...
  function DeviceFrameset2(props) {
    ...
    return (0, import_jsx_runtime.jsxs)(
      ...
      __spreadProps(__spreadValues({
        ...
        style,
        children: [
          (0, import_jsx_runtime.jsx)("div", { className: "inner" }),
          device === "Galaxy Note 8" ? (0, import_jsx_runtime.jsx)("div", { className: "overflow", children: (0, import_jsx_runtime.jsx)("div", { className: "shadow" }) }) : null,
          device === "iPhone X" ? (0, import_jsx_runtime.jsxs)("div", { className: "notch", children: [
            (0, import_jsx_runtime.jsx)("div", { className: "camera" }),
            (0, import_jsx_runtime.jsx)("div", { className: "speaker" })
          ] }) : null,
          (0, import_jsx_runtime.jsx)("div", { className: "top-bar" }),
          (0, import_jsx_runtime.jsx)("div", { className: "sleep" }),
          (0, import_jsx_runtime.jsx)("div", { className: "bottom-bar" }),
          (0, import_jsx_runtime.jsx)("div", { className: "volume" }),
          (0, import_jsx_runtime.jsx)("div", { className: "camera" }),
          (0, import_jsx_runtime.jsx)("div", { className: "sensor" }),
          (0, import_jsx_runtime.jsx)("div", { className: "speaker" }),
          (0, import_jsx_runtime.jsx)("div", { className: "sensors" }),
          (0, import_jsx_runtime.jsx)("div", { className: "more-sensors" }),
          device === "iPhone X" ? (0, import_jsx_runtime.jsxs)("div", { className: "overflow", children: [
            (0, import_jsx_runtime.jsx)("div", { className: "shadow shadow--tr" }),
            (0, import_jsx_runtime.jsx)("div", { className: "shadow shadow--tl" }),
            (0, import_jsx_runtime.jsx)("div", { className: "shadow shadow--br" }),
            (0, import_jsx_runtime.jsx)("div", { className: "shadow shadow--bl" })
          ] }) : null,
          (0, import_jsx_runtime.jsx)("div", { className: "inner-shadow" }),
          (0, import_jsx_runtime.jsx)("div", { className: "screen", children }),
          (0, import_jsx_runtime.jsx)("div", { className: "home" }),
          (0, import_jsx_runtime.jsx)("div", { className: "bottom-bar" })
        ]
      })
    );
...
var DeviceSelector = import_react2.default.memo(function DeviceSelector2(_a) {
  ...
  return (0, import_jsx_runtime2.jsxs)("div", __spreadProps(__spreadValues({ className: "device-selector" }, divProps), { children: [
    (0, import_jsx_runtime2.jsxs)("dl", { children: [
      (0, import_jsx_runtime2.jsxs)("dt", { children: [
      ...
      showMenu && deviceNames.map((devName) => (0, import_jsx_runtime2.jsxs)(
        "dd",
        {
          ...
          children: [
            (0, import_jsx_runtime2.jsx)("input", { type: "radio", id: devName }),
            (0, import_jsx_runtime2.jsxs)("label", { htmlFor: devName, children: [
              (0, import_jsx_runtime2.jsxs)("div", { children: [
                (0, import_jsx_runtime2.jsx)("p", { children: devName }),
                DeviceOptions[devName].hasLandscape && (0, import_jsx_runtime2.jsx)(
                  "span",
                  {
              ...
              (0, import_jsx_runtime2.jsx)("ul", { children: DeviceOptions[devName].colors.map(
                (color) => (0, import_jsx_runtime2.jsx)(
                  "li",
                  {
                    title: color,
    ...
    (0, import_jsx_runtime2.jsx)("div", { className: "device-selector-container", children: children(deviceFramesetProps) })
  ] }));
});
var zooms = [
  0.5,
...
var DeviceEmulator = import_react3.default.memo(function DeviceEmulator2(_a) {
  ...
  return (0, import_jsx_runtime3.jsxs)("div", __spreadProps(__spreadValues({ className: "device-emulator" }, divProps), { children: [
    (0, import_jsx_runtime3.jsxs)("section", { children: [
      (0, import_jsx_runtime3.jsx)("select", { value: selectedDeviceName, onChange: handleSelectChange, children: deviceNames.map((devName) => (0, import_jsx_runtime3.jsx)(
        "option",
        {
          value: devName,
          children: devName
      ...
      (0, import_jsx_runtime3.jsx)("input", { disabled: true, value: width }),
      (0, import_jsx_runtime3.jsx)("span", { children: "x" }),
      (0, import_jsx_runtime3.jsx)("input", { disabled: true, value: height }),
      (0, import_jsx_runtime3.jsx)("select", { value: selectedZoom, onChange: handleSelectZoomChange, children: zooms.map((zoom) => (0, import_jsx_runtime3.jsxs)(
        "option",
        {
          value: zoom,
          children: [
      ...
      (0, import_jsx_runtime3.jsx)("label", { children: "Landscape:" }),
      (0, import_jsx_runtime3.jsx)("input", { type: "checkbox", checked: !!isLandscapeChecked, disabled: !hasLandscape, onChange: handleIsLandscapeChange })
    ] }),
    (0, import_jsx_runtime3.jsx)("div", { className: "device-emulator-container", children: children(deviceFramesetProps) })
  ] }));
});
var steps = [
  0,
...
var Zoomable = import_react4.default.memo(function Zoomable2(_a) {
  ...
  return (0, import_jsx_runtime4.jsxs)("div", __spreadProps(__spreadValues({}, props), { style: __spreadProps(__spreadValues({}, props.style), { position: "relative" }), children: [
    ...
    (0, import_jsx_runtime4.jsxs)("div", { style: { position: "absolute", right: "16px", top: "16px" }, children: [
      (0, import_jsx_runtime4.jsx)("span", { onClick: () => setLocaleScale(toPrev(realScale)), children: "-" }),
      Math.round(realScale * 100),
      "%",
      (0, import_jsx_runtime4.jsx)("span", { onClick: () => setLocaleScale(toNext(realScale)), children: "+" })
    ] })
  ] }));
});
export {
...
//# sourceMappingURL=react-device-frameset.js.map
